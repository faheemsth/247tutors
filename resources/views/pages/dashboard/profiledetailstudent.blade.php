        ...
        <div class="container">
                ...
                <div class="col-12 col-md-9">
                    <div class="row">
                        <div class="col-md-6 mt-lg-5 ard">
                            <h5>{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}<img
                                    src="/assets/images/Verified-p.png" alt=""></h5>
            ...
            <div class="row mt-5 mb-5">
                ...
                <div class="col-12 col-lg-3 col-xl-2 image1 d-flex justify-content-lg-center position-relative">
                    <div  class="profileeditdiv d-flex justify-content-center align-items-center" style="width: 170px;height: 170px;background-color: #cfcfcf;border-radius: 50%; position: absolute;top:0px;">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="form1" runat="server" action="{{ url('/Upload/Image') }}" method="post" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row mt-md-5 mb-md-5 mt-3">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="date" name="dob" value="{{ Auth::user()->dob }}"
                                        class="form-control" id="" required placeholder="Type Your dob" max="9999-12-31">
                                </div>
                            </div>
                            <div class="row mt-md-5 mb-md-5 mt-3">
                                <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" name="zipcode" class="form-control" id="zipcode" required
                                           placeholder="Type Your Postcode" value="{{ Auth::user()->zipcode }}" title="Please enter only numbers">
                                </div>
                            </div>
                            <div class="row mt-md-5 mb-md-5 mt-3">
                                <div class="col-md-6 mb-3 mb-md-0">
