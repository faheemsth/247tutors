            ...
            <div class="col-md-6 col-lg-3  bg-transparent my-2">
                <div class="car text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> @isset($web_settings['tutor_one']) {{$web_settings['tutor_one'] ?? '' }} @endisset</p>
                    </div>
                </div>
            </div>
            <!-- card 2 -->
            <div class="col-md-6 col-lg-3 my-2">
                <div class="car text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> @isset($web_settings['tutor_two']) {{$web_settings['tutor_two'] ?? '' }} @endisset</p>
                    </div>
                </div>
            </div>
            <!-- card 3 -->
            <div class="col-md-6 col-lg-3 my-2">
                <div class="car text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> @isset($web_settings['tutor_three']) {{$web_settings['tutor_three'] ?? '' }} @endisset</p>
                    </div>
                </div>
            </div>
            <!-- card 4 -->
            <div class="col-md-6 col-lg-3 my-2">
                <div class="car text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> @isset($web_settings['tutor_four']) {{$web_settings['tutor_four'] ?? '' }} @endisset</p>
                    </div>
                </div>
            </div>
        </div>
