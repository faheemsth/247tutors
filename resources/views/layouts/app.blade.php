...
<head>
    ...
    <span id="cookieBanner">
        @if (request()->segment(1) == '' ||
                ...
                request()->segment(1) == 'find-tutor' ||
                request()->segment(1) == 'blogs' ||
                request()->segment(1) == 'prices' ||
                request()->segment(1) == 'student-apply-steps' ||
                request()->segment(1) == 'tutor-apply-steps' ||
                request()->segment(1) == 'organization-apply-steps' ||
                request()->segment(1) == 'login-roles' ||
                request()->segment(1) == 'login' ||
                request()->segment(1) == 'sitemap' ||
                request()->segment(1) == 'privacypolicy')
            <style>
                .footer-wrapper {
                ...
                @if (!Auth::check())
                    <div class="d-none row py-3  justify-content-center align-items-baseline" id="cookieBanner">
                        <div class="col-auto text-white">
                            <h6 style="letter-spacing: 0.1rem">We use cookies to personalise your experience on the
                                site. Let us know if you’re ok with this.</h6>
                        </div>
                        <div class="col-auto">
                            <button type="submit" class="btn btn-primary" onclick="cookieUpdate()">YES, THAT'S
                                OK</button>
                        </div>
                    </div>
                    <div id="cookieNotification" class="card" style="display: none;">
                        <div class="card-body">
                            ...
                            <p class="card-text">We use cookies to ensure you get the best experience on our website.
                            </p>
